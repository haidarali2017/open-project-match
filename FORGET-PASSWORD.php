...
<html>
    <head> 
       <script async src="https://www.googletagmanager.com/gtag/js?id=UA-92780683-3"></script>
       <script>
          window.dataLayer = window.dataLayer || [];
          function gtag(){dataLayer.push(arguments);}
          gtag('js', new Date());
          
          gtag('config', 'UA-92780683-3');
       </script>
          ...
          <div id="fullscreenId">
             ...
             <div class="signup bounceInUp animated">
                <div class="columnsTitle" style="text-align:center;padding-top:20px">
                   <span class="white-border-white-background-bubble bubble-padding italic-bold justify" style="color:#000000;text-transform:capitalize;">FORGET PASSWORD</span>
                </div>
                ...
                <div class="signupContainer white_box" id="signupContainerId"> 
                    <form class="no-border-white-background-bubble max-width-static-minimal bubble-5mm-padding" method="post" id="registration_form" name="registration_form" action="">
                        <table class="italic-bold">
                           ...
                           <tr>
                              <td><span class="no-border-3e9721-background-bubble bubble-4mm-important-padding"><strong>Enter your email below<br>to receive new password.</strong></span></td>
                           </tr>
                           ...
                           <!-- <tr>
                              <td><input type="button" value="Submit" style="padding: 11px 16px 11px 14px !important;" onclick="this.form.submit();"></td>
                           </tr> -->
