         ...
         <div id="fullscreenId">
            ...
            <div class="signup bounceInUp animated">
               <div class="columnsTitle" style="text-align:center;padding-top:20px">
                  <span class="white-border-white-background-bubble bubble-padding italic-bold justify" style="color:#15BB39;text-transform:capitalize;">CATEGORY UPDATE</span>
               </div>
               ...
               <div class="signupContainer white_box" id="signupContainerId"> 
                  <form class="no-border-white-background-bubble max-width-static-minimal bubble-5mm-padding" method="post" id="registration_form" name="registration_form" action="">
                     ...
                     <table class="italic-bold">                     
                        ...
                        <tr>
                           <td>                             
                              <textarea class="red" rows="1" name="category_name" id="category_name" placeholder="Category Name*" oninput="auto_height(this, 45);" autocomplete="off" autocorrect="off" autocapitalize="off" style="height:60px;padding: 11px 16px 11px 14px !important;">information Technolgory</textarea>
                           </td>
                        </tr> 
