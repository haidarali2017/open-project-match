         ...
         <div id="fullscreenId">
            ...
            <div class="signup bounceInUp animated">
               <div class="columnsTitle" style="text-align:center;padding-top:20px">
                  <span class="white-border-white-background-bubble bubble-padding italic-bold justify" style="color:#15BB39;text-transform:capitalize;">SUB CATEGORY LIST</span>
               </div>
                  ...
                  <table class="table table-striped text-center" width="100%">
                     ...
                     <thead>
                       <tr>
                         ...
                         <th style="border-bottom: 1px solid black;">Sub Category</th> 
                         <th style="border-bottom: 1px solid black;" class="text-end">Actions</th>
                       </tr>
                     </thead>
                   
                     <tbody class="category" >
                       <tr class="success" id="category_id_149">
                         <td>1</td> 
                         <td class="align-middle">Information Technology</td>                           
                         <td class="align-middle">Web Developer</td>                           
                         <td class="text-end">
                          <a href="EDIT-SUB-CATEGORY.php"
                            class="edit-icon">
                            <img src="img/edit.png" alt="edi-icon"  style="height: 20px;">
                          </a>
                          <a class="delete-icon">
                            <img src="img/delete.png" alt="edi-icon" style="height: 20px;">
                          </a>
                        </td>
                       </tr>
                       <tr class="success" id="category_id_149">
                      ...
                      <tr class="success" id="category_id_149">
                        <td>3</td> 
                        <td class="align-middle">Data entry</td>                           
                        <td class="align-middle">School</td>                           
                        <td class="text-end">
                          <a href="EDIT-SUB-CATEGORY.php"
                            class="edit-icon">
                            <img src="img/edit.png" alt="edi-icon"  style="height: 20px;">
